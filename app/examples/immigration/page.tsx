...
export default function ImmigrationExample() {
  return (
    <div className="min-h-screen bg-[#F5F2ED]">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 py-12 space-y-12">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#6B6560]">
          ...
          <span>/</span>
          <span className="text-[#0F1419] font-medium">Immigration & Asylum Filing Packet</span>
        </nav>

        {/* Hero Section */}
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-emerald-100 border border-emerald-200 px-4 py-1.5">
            <span className="text-sm font-semibold text-emerald-800">USCIS-ready</span>
          </div>

          <h1 className="text-4xl sm:text-5xl font-bold text-[#0F1419] tracking-tight">
            Immigration & Asylum Filing Packet
          </h1>

          <p className="text-lg text-[#6B6560] max-w-3xl leading-relaxed">
            Passports, affidavits, country condition reports, and supporting documents compiled into a structured, USCIS-ready PDF with clear section dividers and consistent formatting.
          </p>
        </div>
        ...
        <div className="rounded-2xl border-2 border-[#E5E0D8] bg-white shadow-xl overflow-hidden">
          <NextImage
            src="/examples/immigration-cover.png"
            alt="Immigration filing packet preview showing plaintiff exhibits with passport, affidavit, and country conditions report"
            width={1200}
            height={800}
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-[#6B6560]">
                <li className="flex items-start gap-2">
                  ...
                  <span>Passport & identity documents (4 pages)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Affidavit of support (3 pages)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Country conditions report (8 pages)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Financial records & correspondence (5 pages)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-[#6B6560]">
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>USCIS-ready exhibit labels (A-D)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Section dividers with tab markers</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Consistent page sizing & margins</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
        ...
        <div className="rounded-3xl border border-[#E5E0D8] bg-gradient-to-br from-white to-gray-50 p-8 sm:p-10 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#0F1419] mb-1">Gather Supporting Evidence</h3>
                <p className="text-sm text-[#6B6560]">
                  Uploaded passport scans, affidavit PDFs, country condition report, and supplemental financial proof.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#0F1419] mb-1">Auto-Label & Organize</h3>
                <p className="text-sm text-[#6B6560]">
                  CaseReady assigned exhibits A-D, added tab dividers, and normalized formatting for USCIS submission.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#0F1419] mb-1">Export the Filing Packet</h3>
                <p className="text-sm text-[#6B6560]">
                  Exported a clean, single PDF with section dividers, cover sheet, and consistent pagination.
                </p>
              </div>
            </div>
          </div>
