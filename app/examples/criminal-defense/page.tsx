...
export default function CriminalDefenseExample() {
  return (
    <div className="min-h-screen bg-[#F5F2ED]">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 py-12 space-y-12">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#6B6560]">
          ...
          <span>/</span>
          <span className="text-[#0F1419] font-medium">Criminal Defense Trial Exhibits</span>
        </nav>

        {/* Hero Section */}
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-green-100 border border-green-200 px-4 py-1.5">
            <span className="text-sm font-semibold text-green-800">High Volume</span>
          </div>

          <h1 className="text-4xl sm:text-5xl font-bold text-[#0F1419] tracking-tight">
            Criminal Defense Trial Exhibits
          </h1>

          <p className="text-lg text-[#6B6560] max-w-3xl leading-relaxed">
            Police reports, body-cam footage stills, discovery PDFs, and witness statements compiled into a clean, court-ready exhibit packet. Automatically labeled, chronologically ordered, and formatted for trial submission.
          </p>
        </div>
        ...
        <div className="rounded-2xl border-2 border-[#E5E0D8] bg-white shadow-xl overflow-hidden">
          <NextImage
            src="/examples/criminal-defense-cover.png"
            alt="Criminal Defense exhibits preview showing defendant's exhibits with police report, body-cam footage, and witness statements"
            width={1200}
            height={800}
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-[#6B6560]">
                <li className="flex items-start gap-2">
                  ...
                  <span>Police Report (2 pages)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Body-Cam Footage Stills (6 pages)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Discovery Documents (8 pages)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Witness Statement (2 pages)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-[#6B6560]">
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Auto-generated Bates numbers (A001-A018)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Professional cover page with table of contents</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-brand-royal)] mt-0.5">•</span>
                  <span>Chronological ordering by date detected</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="rounded-3xl border border-[#E5E0D8] bg-gradient-to-br from-white to-gray-50 p-8 sm:p-10 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#0F1419] mb-1">Upload Evidence Files</h3>
                <p className="text-sm text-[#6B6560]">
                  Dragged in 4 PDFs: police report, discovery docs, witness statement, and body-cam stills exported as PDF.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#0F1419] mb-1">Auto-Label & Order</h3>
                <p className="text-sm text-[#6B6560]">
                  CaseReady detected dates, numbered exhibits 1-4, assigned Bates ranges, and sorted chronologically.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#0F1419] mb-1">Generate & Export</h3>
                <p className="text-sm text-[#6B6560]">
                  Clicked "Export" and got a single PDF ready for court filing—cover page, table of contents, and all.
                </p>
              </div>
            </div>
          </div>
